...
const BLOG = {
  ...
  NOTION_PAGE_ID:'ea8b69e2ac8582ce84738131a43f731b',
  ...
  SINCE: 2026, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '村长', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享区块链、AI、网络媒体相关知识！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.cunzhangblog.com/', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '分享区块链、AI、网络媒体相关知识！,欢迎来到Web3村长的博客🎉',
